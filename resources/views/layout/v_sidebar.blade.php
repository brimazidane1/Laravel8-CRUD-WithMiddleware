<nav id="sidebar" class="sidebar">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="{{ asset('adminkit/static') }}/index.html">
            <span class="align-middle">Bappeda Pekanbaru</span>
        </a>
      ...
      <i class="align-middle" data-feather="search"></i>
        ...
        <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="{{ Auth::user()->name }}" /> <span class="text-dark">{{ Auth::user()->name }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="{{ asset('adminkit/static') }}/pages-profile.html"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
